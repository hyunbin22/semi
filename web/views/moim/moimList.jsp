 ...
 <section class="center1">
        ...
        <div id="searchContainer">
			<select id="searchType">
				...
				<option value="moim_keyword" <%="mName".equals(searchType)?"selected":"" %>>키워드</option>
			</select> 
			<div id="search-mId">
	 		...
	 		<div id="search-mName">
				<form action="<%=request.getContextPath()%>/moim/moimListFind.do">
					...
					<input type="hidden" name="cPage" value="<%=cPage%>"> 
					<input type="text" name="searchKeyword" placeholder="작성자이름 입력"
        ...
        <%if(memberLogin != null){ %>
            <div><a onclick = "location.href='<%=request.getContextPath()%>/moim/moimEnroll.do?'"><input class="notice-write next" type="button" value="게시글 작성"></a></div>
            <%} %>
