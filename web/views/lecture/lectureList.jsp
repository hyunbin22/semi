...
<p id="title">강좌리스트</p>
    ...
    <div class="class1">
        ...
        <table class="classtable"  style="cursor:pointer;">
            
            <tr>
                <td colspan="4"><img src="<%=request.getContextPath()%>/upload/lectureUpload/<%=lec.getLectureUpList()%>"></td>
            </tr>
            <tr>
