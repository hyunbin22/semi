...
<section class="center1">
	<article class="wrap">
		<div class="bar">
			<br>
			<br>
			<h1 class = "center1">이용약관</h1>
			<br>
			<hr>
		</div>
		<form action="<%=request.getContextPath() %>/views/member/register_textForm.jsp" method="post" onsubmit="return checkAgree();">
			<table class="tbl-register2 center1">
				...
				<tr>
					<td>
						<p>정보통신망법 규정에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및
					...
					네이버는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다. 회원가입 시점에 네이버가 이용자로부터 수집하는
