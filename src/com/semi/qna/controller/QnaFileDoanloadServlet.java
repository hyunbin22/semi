...
/**
 * Servlet implementation class QnaFileDoanloadServlet
 */
@WebServlet("/qna/qnaFileDown")
public class QnaFileDoanloadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QnaFileDoanloadServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//1.경로
		String saveDir=getServletContext().getRealPath("/upload/qnaupload");
