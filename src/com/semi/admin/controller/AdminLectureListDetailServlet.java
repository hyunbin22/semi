...
/**
 * Servlet implementation class AdminLectureListDetailServlet
 */
@WebServlet("/admin/AdminLectureListDetail.do")
public class AdminLectureListDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminLectureListDetailServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/views/admin/adminLectureListDetail.jsp").forward(request, response);
