...
/**
 * Servlet implementation class AdminLectureTitleFinderServlet
 */
@WebServlet("/admin/lectureNameFinder.do")
public class AdminLectureTitleFinderServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminLectureTitleFinderServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Lecture> lectureList = new LectureService().lectureApproFindList4(data, cPage, numPerPage);
		...
		request.getRequestDispatcher("/views/admin/adminLectureNameListFinder.jsp").forward(request, response);
	}
