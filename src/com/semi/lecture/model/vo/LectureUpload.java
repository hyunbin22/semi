...
public class LectureUpload {
   ...
   public LectureUpload(int lecNum, String upLectureOrgCover, String upLectureReCover,
   ...
   public LectureUpload( String upLectureOrgCover, String upLectureReCover, String upLectureOrgLecImg, String upLectureReLecImg) {
      super();
      this.upLectureOrgCover = upLectureOrgCover;
      this.upLectureReCover = upLectureReCover;
      this.upLectureOrgLecImg = upLectureOrgLecImg;
