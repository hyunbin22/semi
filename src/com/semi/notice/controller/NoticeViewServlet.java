...
public class NoticeViewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Notice n=new NoticeService().selectNotice(nNum);
		NoticeUpload nu=new NoticeService().selectNoticeUpload(nNum);
		
		request.setAttribute("notice", n);
		request.setAttribute("noticeUpload", nu);
		request.getRequestDispatcher("/views/notice/notice_view.jsp").forward(request, response);
	}
